...
Public Class FrmMail
    ...
    'Procedimiento
    Private Sub EnviarMail(ByVal StrDe As String, ByVal StrPara As String, ByVal StrAsunto As String, ByVal sAdjunto() As String, ByVal StrMensaje As String)
        Try
            ...
            'Credenciales
            SMPT.Credentials = New System.Net.NetworkCredential("cuenta", "password")
