Module Module1
    ...
    Sub Main()
        ...
        'Console.WriteLine("Nombre: " & Nombre & " Número: " & numero)
        'Console.WriteLine("Nombre:{0}  Número:{1} - {2}", Nombre, numero, Valor)
        'Dim LineaTexto As String
        'Console.Write("Introduce un texto:")
        'LineaTexto = Console.ReadLine()
        'Console.WriteLine("Introduce un texto: {0}", LineaTexto)
        'Console.ReadLine()
